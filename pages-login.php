...
if (isset($_POST['login_guest'])) {
  ...
  else $password_err = "please enter valid password";
  ...
  if (!empty($email) && !empty($password)) {
    ...
    if ($result->num_rows > 0) {
      ...
      $error_mesg = "Email or Password Not matched";
    }
    $conn->close();
  }
}
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" novalidate>
                    ...
                    <span class="text-danger"><?php if (isset($error_mesg)) echo $error_mesg; ?></span>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="login_guest">Login</button>
                    </div>
                    <div class="col-12">
